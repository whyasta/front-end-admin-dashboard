...
type ConfirmationType = 'delete-account' | 'unsubscribe' | 'suspend-account' | 'delete-order' | 'delete-customer' | 'delete'
...
type ConfirmationDialogProps = {
  ...
  data?: any
  onConfirm: (value: boolean, data?: any) => void
}

const ConfirmationDialog = ({ open, setOpen, type, data, onConfirm }: ConfirmationDialogProps) => {
  // States
