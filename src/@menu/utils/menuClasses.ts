...
export const menuClasses = {
  ...
  menuItemRoot: 'ts-menuitem-root finpay-menuitem-root',
  subMenuRoot: 'ts-submenu-root finpay-menuitem-root',
  button: 'ts-menu-button',
  prefix: 'ts-menu-prefix',
  suffix: 'ts-menu-suffix',
  label: 'ts-menu-label',
  icon: 'ts-menu-icon finpay-menu-icon',
  ...
  subMenuContent: 'ts-submenu-content finpay-submenu-content',
